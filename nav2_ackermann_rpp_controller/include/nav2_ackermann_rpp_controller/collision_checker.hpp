...
#ifndef NAV2_ACKERMANN_RPP_CONTROLLER__COLLISION_CHECKER_HPP_
#define NAV2_ACKERMANN_RPP_CONTROLLER__COLLISION_CHECKER_HPP_
...
/**
 * @class nav2_ackermann_rpp_controller::CollisionChecker
...
public:
  /**
   * @brief Constructor for nav2_ackermann_rpp_controller::CollisionChecker
   */
  CollisionChecker(
  ...
  /**
   * @brief Destrructor for nav2_ackermann_rpp_controller::CollisionChecker
   */
...
#endif  // NAV2_ACKERMANN_RPP_CONTROLLER__COLLISION_CHECKER_HPP_
