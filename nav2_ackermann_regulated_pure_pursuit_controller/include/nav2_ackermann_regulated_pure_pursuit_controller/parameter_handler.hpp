...
#ifndef NAV2_ACKERMANN_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_
#define NAV2_ACKERMANN_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_
...
struct Parameters
{
  ...
  double steering_angle_tolerance;      // steering angle tracking tolerance (rad)
  double steering_angle_release_tolerance;  // hysteresis: latch releases below this error (rad)
...
/**
 * @class nav2_ackermann_regulated_pure_pursuit_controller::ParameterHandler
...
public:
  /**
   * @brief Constructor for nav2_ackermann_regulated_pure_pursuit_controller::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destrructor for nav2_ackermann_regulated_pure_pursuit_controller::ParameterHandler
   */
  ~ParameterHandler();
...
#endif  // NAV2_ACKERMANN_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_
